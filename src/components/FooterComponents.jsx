      ...
      <div className="container">
        <div id="container" className="row mb-5">
          <div id="social" className="col-md-3">
            <div className="reveal ftco-footer-widget mb-4">
              <h2 className="ftco-heading-2">DentaCare.</h2>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            </div>
            <ul className="ftco-footer-social list-unstyled float-md-left float-lft ">
              <li className="reveal ftco-animate"><a href="#"><i className="fa-brands fa-x-twitter fa-2xl"></i></a></li>
              <li className="reveal ftco-animate"><a href="#"><i className="fa-brands fa-facebook-f fa-2xl"></i></a></li>
              <li className="reveal ftco-animate"><a href="#"><i className="fa-brands fa-instagram fa-2xl"></i></a></li>
            </ul>
          </div>
          <div id="container" className="col-md-2">
            <div id="quick" className="ftco-footer-widget mb-4 ml-md-5">
              <h2 className="reveal ftco-heading-2">Quick Links</h2>
              <ul className="reveal quick list-unstyled">
          ...
          <div id="container" className="col-md-3">
            <div className="ftco-footer-widget mb-4">
            	<h2 className="reveal ftco-heading-2">Office</h2>
            	<div className="block-23 mb-3">
	              <ul className="reveal list-unstyled">
